 ...
 * @author dmle
 * @version 2017
 * @overview Represents method references to attributes of the same class.
 * @example The following example demonstrates how to use {@link AttrRef} to declare that
